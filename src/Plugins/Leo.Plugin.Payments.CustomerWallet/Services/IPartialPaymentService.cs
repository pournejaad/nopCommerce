...
namespace Leo.Plugin.Payments.CustomerWallet.Services
{
    public interface IPartialPaymentService
    {
        ...
        Task<IList<PartialPaymentProductMapping>> GetPartialPaymentMappingsByPartialPaymentId(int partialPaymentId);
        Task DeletePartialPaymentAsync(PartialPayment partialPayment);
        Task DeletePartialPaymentProductMappingAsync(PartialPaymentProductMapping partialPaymentProductMapping);
    }
    ...
    public class PartialPaymentService : IPartialPaymentService
    {
        ...
        public async Task<IList<PartialPaymentProductMapping>> GetPartialPaymentMappingsByPartialPaymentId(int partialPaymentId)
        {
            return await _partialPaymentProductMappingRepository.Table
                .Where(x => x.PartialPaymentId == partialPaymentId).ToListAsync();
        }

        public async Task DeletePartialPaymentAsync(PartialPayment partialPayment)
        {
            var partialPaymentProducts = await GetPartialPaymentMappingsByPartialPaymentId(partialPayment.Id);
            await _partialPaymentProductMappingRepository
                .DeleteAsync(partialPaymentProducts);
            await _partialPaymentRepository.DeleteAsync(partialPayment);
        }

        public async Task DeletePartialPaymentProductMappingAsync(PartialPaymentProductMapping partialPaymentProductMapping)
        {
            await _partialPaymentProductMappingRepository.DeleteAsync(partialPaymentProductMapping);
        }
    }
}