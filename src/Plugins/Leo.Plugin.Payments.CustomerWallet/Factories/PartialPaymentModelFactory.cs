...
namespace Leo.Plugin.Payments.CustomerWallet.Factories
{
    ...
    public class PartialPaymentModelFactory : IPartialPaymentModelFactory
    {
        ...
        public Task<PartialPaymentSearchModel> PreparePartialPaymentSearchModelAsync(
            ...
            PartialPaymentSearchModel searchModel)
        {
            ...
            var model = new PartialPaymentListModel().PrepareToGrid(searchModel,
                partialPayments, () =>
                {
                    return partialPayments.Select(pp => pp.ToModel<PartialPaymentModel>());
                });
            return model;
        }
            ...
            PartialPayment partialPayment)
        {
            ...
            var psPaged = await ps.ToPagedListAsync(searchModel.Page - 1,
